...
public final class RebornAgentCatalog {
    ...
    private static final AgentProfile[] AGENTS = new AgentProfile[] {
            new AgentProfile(
                    ...
                    "Olá, está a falar com a MyPoupar. Esta chamada usa assistência de voz para transformar a conversa em texto e gerar respostas. Se estiver de acordo, continuamos."
            ),
            new AgentProfile(
                    "lumin_savings",
